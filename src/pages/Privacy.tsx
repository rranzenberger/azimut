...
const Privacy: React.FC<PrivacyProps> = ({ lang }) => {
  ...
  const content = {
    ...
    // EN, FR, ES versões podem ser adicionadas depois
    en: { title: 'Privacy Policy', subtitle: 'How we protect your data', lastUpdate: 'Last updated: January 2026', sections: [] },
    fr: { title: 'Confidentialité', subtitle: 'Protection de vos données', lastUpdate: 'Dernière mise à jour : Janvier 2026', sections: [] },
    es: { title: 'Privacidad', subtitle: 'Protección de sus datos', lastUpdate: 'Última actualización: Enero 2026', sections: [] }
  }
