  ...
  return (
    <>
      ...
      <main className="relative min-h-screen overflow-hidden pt-6 md:pt-8 pb-24 film-grain">
        {/* Background: Estrela da Azimut - FIXA (posição mais alta como na imagem) */}
        <div
          className="fixed top-20 -right-28 h-[520px] w-[520px] md:top-24 md:-right-40 md:h-[680px] md:w-[680px] opacity-0.3 pointer-events-none"
          style={{
            zIndex: 0,
