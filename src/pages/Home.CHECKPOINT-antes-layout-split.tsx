  ...
  return (
    <>
      ...
      <main className="relative">
        ...
        {/* ════════════════════════════════════════════════════════════════ */}
        {/* HERO PREMIUM 2026 - LOGO WATERMARK GIGANTE */}
        {/* Padrão: Stripe, Vercel, Linear (Elegância Máxima) */}
        {/* ════════════════════════════════════════════════════════════════ */}
        <section className="relative h-screen min-h-[700px] overflow-hidden">
          {/* Background: Gradiente premium */}
          <div className="absolute inset-0 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950" />
          
          {/* LOGO ANIMADA GIGANTE WATERMARK (z-index 0) */}
          <div className="absolute inset-0 flex items-center justify-center z-0 opacity-20 pointer-events-none">
            <div className="w-[60vh] h-[60vh] md:w-[65vh] md:h-[65vh]">
              <AnimatedLogo />
            </div>
          </div>
          
          {/* Grain texture cinematográfico (z-index 1) */}
          ...
          {/* Logo pequena canto superior esquerdo (z-index 20) */}
          ...
          {/* Conteúdo centralizado (z-index 10 - na frente da logo watermark) */}
          <div className="relative z-10 h-full flex flex-col items-center justify-center px-4 sm:px-6 lg:px-8 gap-6">
            ...
            <div className="flex flex-wrap justify-center gap-3 text-[0.75rem] uppercase tracking-wider animate-fade-in-up opacity-0" style={{ animationDelay: '0.4s' }}>
              ...
              <span className="text-white/70">VR/XR</span>
              <span className="text-white/30">•</span>
              <span className="text-white/70">IA</span>
              <span className="text-white/30">•</span>
              <span className="text-white/70">{lang === 'pt' ? 'Curadoria' : lang === 'es' ? 'Curaduría' : lang === 'fr' ? 'Curation' : 'Curation'}</span>
            </div>
            
            {/* Stats inline */}
            <p className="text-white/60 text-[0.8rem] uppercase tracking-widest animate-fade-in-up opacity-0" style={{ animationDelay: '0.5s' }}>
