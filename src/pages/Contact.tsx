    ...
    <>
      ...
      <main className="relative pt-6 md:pt-8 pb-24">
        ...
        <div className="mx-auto max-w-7xl px-3 sm:px-4 md:px-6 lg:px-8">
          ...
          <p className="mb-6 text-lg leading-relaxed text-slate-50 dark:text-slate-300">
            {t(lang, 'contactNote')}
          </p>
          ...
          <div className="grid gap-8 lg:grid-cols-[1.1fr,0.9fr]">
            ...
            {mode === 'wizard' && (
              <div className="space-y-6 rounded-2xl border border-white/10 card-adaptive p-8 shadow-[0_16px_40px_rgba(0,0,0,0.4)] backdrop-blur">
                ...
                <button
                  ...
                  className="w-full rounded-xl bg-azimut-red px-6 py-4 font-sora text-sm font-semibold uppercase tracking-[0.12em] transition hover:brightness-110 shadow-[0_8px_24px_rgba(var(--theme-accent-red-rgb),0.3)] text-white"
                >
            ...
            {mode === 'form' && (
              ...
              <div className="grid gap-3 sm:grid-cols-2">
                <label className="flex flex-col gap-1 text-sm text-slate-50 dark:text-slate-200">
                  {i18n(labels.name)}
