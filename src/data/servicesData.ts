...
export const servicesData: Service[] = [
  ...
  },
  {
    ...
    icon: '🌐',
    titlePt: 'XR, VR & Experiências Imersivas',
    titleEn: 'XR, VR & Immersive Experiences',
    titleFr: 'XR, VR & Expériences immersives',
    titleEs: 'XR, VR y Experiencias inmersivas',
  ...
  },
  {
    ...
    longDescPt: [
      'Pioneiros em pesquisa de IA para narrativas no Brasil (desde 1997), desenvolvemos expertise única na intersecção entre inteligência artificial e storytelling. Com mais de 25 anos explorando o potencial da IA criativa, acumulamos conhecimento profundo sobre como integrar tecnologias emergentes com linguagem cinematográfica tradicional.',
      'Criamos pipelines que usam Stable Diffusion, Midjourney, RunwayML e ferramentas custom para acelerar pré-produção, criar concept art, storyboards e até sequências animadas experimentais. Nossa experiência prática nos permite identificar quais ferramentas funcionam melhor para cada tipo de projeto, otimizando tempo e recursos sem comprometer qualidade.',
      'Nossa abordagem não substitui artistas, mas potencializa a criatividade humana, permitindo iterar rapidamente e explorar direções visuais inovadoras. Acreditamos que IA é uma ferramenta poderosa que amplifica a capacidade criativa, não a substitui. Por isso, sempre combinamos geração por IA com direção de arte humana e refinamento manual.',
      'Pesquisa e desenvolvimento são parte fundamental de nosso trabalho. Mantemos-nos atualizados com as últimas ferramentas de IA generativa, testando e validando novas tecnologias antes de integrá-las em nossos pipelines. Isso nos permite oferecer soluções inovadoras que estão na vanguarda da indústria criativa.',
      'Concept art gerado por IA é uma de nossas especialidades. Utilizamos Midjourney, DALL-E e Stable Diffusion para criar visualizações conceituais que aceleram o processo de pré-produção. Nossos prompts são cuidadosamente desenvolvidos para gerar resultados que se alinham com a visão criativa do projeto, reduzindo tempo de iteração de dias para horas.',
      'Storyboards acelerados com IA permitem que equipes explorem múltiplas direções narrativas rapidamente. Combinamos geração por IA com edição manual para criar storyboards detalhados que servem como guia visual para toda a produção. Isso economiza tempo significativo na fase de pré-produção, permitindo que equipes foquem em refinar as melhores ideias.',
      'Video-to-video styling é uma tecnologia que estamos explorando ativamente. Utilizamos Runway ML, Pika Labs e outras ferramentas para aplicar estilos visuais a vídeos existentes, criando variações estéticas que seriam impossíveis ou extremamente caras de produzir manualmente. Isso abre novas possibilidades criativas para projetos com orçamentos limitados.',
      'Treinamento de modelos custom é oferecido para clientes que precisam de resultados muito específicos. Trabalhamos com fine-tuning de modelos existentes e treinamento de modelos do zero quando necessário. Isso permite criar IAs que geram conteúdo alinhado com identidade visual específica de cada marca ou projeto.',
      'Consultoria em IA criativa é um serviço que oferecemos para empresas que querem adotar essas tecnologias mas não sabem por onde começar. Ajudamos a identificar oportunidades, selecionar ferramentas adequadas, desenvolver workflows e treinar equipes. Nossa experiência prática garante que a adoção de IA seja estratégica e eficiente.'
    ],
    longDescEn: [
      'Pioneers in AI research for narratives in Brazil (since 1997), we have developed unique expertise at the intersection of artificial intelligence and storytelling. With over 25 years exploring the potential of creative AI, we have accumulated deep knowledge about how to integrate emerging technologies with traditional cinematic language.',
      'We create pipelines that use Stable Diffusion, Midjourney, RunwayML and custom tools to accelerate pre-production, create concept art, storyboards and even experimental animated sequences. Our practical experience allows us to identify which tools work best for each type of project, optimizing time and resources without compromising quality.',
      'Our approach doesn\'t replace artists, but enhances human creativity, allowing rapid iteration and exploration of innovative visual directions. We believe AI is a powerful tool that amplifies creative capacity, not replaces it. That\'s why we always combine AI generation with human art direction and manual refinement.',
      'Research and development are fundamental parts of our work. We stay updated with latest generative AI tools, testing and validating new technologies before integrating them into our pipelines. This allows us to offer innovative solutions that are at the forefront of the creative industry.',
      'AI-generated concept art is one of our specialties. We use Midjourney, DALL-E and Stable Diffusion to create conceptual visualizations that accelerate pre-production process. Our prompts are carefully developed to generate results that align with project\'s creative vision, reducing iteration time from days to hours.',
      'AI-accelerated storyboards allow teams to explore multiple narrative directions quickly. We combine AI generation with manual editing to create detailed storyboards that serve as visual guide for entire production. This saves significant time in pre-production phase, allowing teams to focus on refining best ideas.',
      'Video-to-video styling is a technology we are actively exploring. We use Runway ML, Pika Labs and other tools to apply visual styles to existing videos, creating aesthetic variations that would be impossible or extremely expensive to produce manually. This opens new creative possibilities for projects with limited budgets.',
      'Custom model training is offered for clients who need very specific results. We work with fine-tuning existing models and training models from scratch when needed. This allows creating AIs that generate content aligned with specific visual identity of each brand or project.',
      'Creative AI consulting is a service we offer for companies that want to adopt these technologies but don\'t know where to start. We help identify opportunities, select appropriate tools, develop workflows and train teams. Our practical experience ensures AI adoption is strategic and efficient.'
    ],
    longDescFr: [
  ...
  },
  {
    ...
    longDescPt: [
      'Com 30 anos de experiência, nossa diretora de arte Aick liderou projetos complexos como o Rio Museu Olímpico, integrando cenografia, tecnologia, audiovisual e design gráfico. Essa experiência única nos posiciona como referência em direção de arte para projetos culturais e institucionais de grande escala.',
      'Oferecemos direção de arte completa: desde conceito e identidade visual até supervisão de produção e garantia de qualidade estética em todas as entregas. Trabalhamos como guardiões da visão criativa, garantindo que cada elemento visual contribua para a narrativa geral do projeto.',
      'Nossa abordagem integra pesquisa visual, referências culturais, tendências contemporâneas e coerência narrativa para criar experiências visuais únicas. Cada projeto recebe tratamento personalizado, com desenvolvimento de identidade visual que reflete valores, história e objetivos da instituição ou marca.',
      'Conceito e mood board são o ponto de partida de todos nossos projetos. Realizamos pesquisas visuais extensivas, coletando referências de arte, design, cinema, arquitetura e cultura. Desenvolvemos mood boards que comunicam a atmosfera e estética desejada, servindo como guia visual para toda a equipe criativa.',
      'Identidade visual completa é desenvolvida com atenção aos detalhes. Criamos sistemas de design que se estendem por todos os elementos visuais: logotipos, tipografia, paleta de cores, iconografia, fotografia e motion graphics. Cada elemento é pensado para funcionar harmoniosamente com os outros, criando uma experiência visual coesa.',
      'Style guide detalhado é entregue em todos nossos projetos. Documentamos padrões visuais, especificações técnicas, guias de uso e exemplos práticos. Isso garante que a identidade visual seja aplicada consistentemente mesmo após nossa participação, mantendo qualidade e coerência ao longo do tempo.',
      'Supervisão de produção é parte essencial de nosso trabalho. Acompanhamos todas as etapas de produção, desde fotografia e vídeo até design gráfico e desenvolvimento web. Nossa experiência garante que cada elemento visual seja executado conforme a visão criativa, mantendo padrões de qualidade e coerência estética.',
      'Coordenação de equipes criativas é uma de nossas especialidades. Trabalhamos com fotógrafos, videomakers, designers, ilustradores e desenvolvedores, garantindo que todos estejam alinhados com a visão criativa. Nossa experiência em gestão de projetos criativos nos permite coordenar equipes multidisciplinares de forma eficiente.',
      'Quality assurance estético é realizado em todas as entregas. Revisamos cada elemento visual para garantir que atenda padrões de qualidade, coerência com identidade visual e objetivos do projeto. Nossa atenção aos detalhes garante que o resultado final seja premium e profissional.'
    ],
    longDescEn: [
  ...
  },
  {
    ...
    shortDescPt: 'Consultoria estratégica e treinamento corporativo para projetos culturais e tecnológicos. Captação de recursos via editais, estratégia de IA e capacitação de equipes em tecnologias imersivas e audiovisuais.',
    shortDescEn: 'Strategic consulting and corporate training for cultural and technological projects. Resource acquisition through grants, AI strategy and team training in immersive and audiovisual technologies.',
    shortDescFr: 'Conseil stratégique et formation d\'entreprise pour projets culturels et technologiques. Acquisition de ressources via subventions, stratégie IA et formation d\'équipes en technologies immersives et audiovisuelles.',
    shortDescEs: 'Consultoría estratégica y capacitación corporativa para proyectos culturales y tecnológicos. Captación de recursos vía convocatorias, estrategia de IA y capacitación de equipos en tecnologías inmersivas y audiovisuales.',
    longDescPt: [
