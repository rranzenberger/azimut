        ...
        <div className="py-4 sm:py-5 min-[768px]:py-6" style={{ width: '100%', boxSizing: 'border-box', overflowX: 'visible' }}>
          ...
          <div className="min-[768px]:hidden">
            ...
            <div className="text-center mb-6">
              <LangLink to="/" className="inline-block mb-2">
                <img 
                  src="/logo-topo-site.svg"
                  alt="Azimut" 
                  className="opacity-90 h-10 w-auto mx-auto"
                />
              </LangLink>
              <p className="text-[0.7rem] text-slate-400 leading-relaxed max-w-xs mx-auto">
                {t(lang, 'heroLead').split('–')[0].trim()}
              </p>
              {/* Cidades */}
              <div className="flex items-center justify-center gap-2 mt-2 text-slate-500">
                <div className="flex items-center gap-1">
                  <img src="/flag-ca.svg" alt="Canada" className="h-2.5 w-auto rounded-[2px]" />
                  <span className="text-[0.65rem]">Vancouver</span>
                </div>
                <span className="text-[0.55rem] opacity-50">•</span>
                <div className="flex items-center gap-1">
                  <img src="/flag-br.svg" alt="Brasil" className="h-2.5 w-auto rounded-[2px]" />
                  <span className="text-[0.65rem]">Rio • Floripa</span>
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-3 gap-4 mb-6 text-center">
              ...
              <nav className="flex flex-col gap-2">
                ...
                <LangLink to="/academy/courses" className="text-[0.7rem] text-slate-400 hover:text-azimut-red">{lang === 'pt' ? 'Cursos' : 'Courses'}</LangLink>
                <LangLink to="/academy/corporate" className="text-[0.7rem] text-slate-400 hover:text-azimut-red">Corporate</LangLink>
              </nav>
              <nav className="flex flex-col gap-2">
                <h4 className="font-sora text-[0.6rem] font-semibold uppercase tracking-wider text-white mb-1">
            ...
            <div className="flex justify-center mb-5">
              <LangLink to="/contact" 
                className="flex flex-col items-center justify-center rounded-xl border px-6 py-2.5 text-[0.7rem] font-medium transition-all"
                style={{ 
                  color: '#ffffff',
            ...
            <div className="flex items-center justify-center gap-4 mb-6">
              ...
              <a href="https://vimeo.com/azimutart" target="_blank" rel="noopener noreferrer" className="text-white/60 hover:text-cyan-500 transition-colors" aria-label="Vimeo">
                <svg fill="currentColor" viewBox="0 0 24 24" className="w-5 h-5"><path d="M23.977 6.416c-.105 2.338-1.739 5.543-4.894 9.609-3.268 4.247-6.026 6.37-8.29 6.37-1.409 0-2.578-1.294-3.553-3.881L5.322 11.4C4.603 8.816 3.834 7.522 3.01 7.522c-.179 0-.806.378-1.881 1.132L0 7.197c1.185-1.044 2.351-2.084 3.501-3.128C5.08 2.701 6.266 1.984 7.055 1.91c1.867-.18 3.016 1.1 3.447 3.838.465 2.953.789 4.789.971 5.507.539 2.45 1.131 3.674 1.776 3.674.502 0 1.256-.796 2.265-2.385 1.004-1.589 1.54-2.797 1.612-3.628.144-1.371-.395-2.061-1.614-2.061-.574 0-1.167.121-1.777.391 1.186-3.868 3.434-5.757 6.762-5.637 2.473.06 3.628 1.664 3.493 4.797l-.013.01z"/></svg>
              </a>
            ...
            <div className="text-center mb-5">
              ...
              <a href="mailto:contact@azimutimmersive.com" className="text-[0.7rem] text-slate-400 hover:text-azimut-red block mb-2">
              ...
              <a 
                ...
                className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-[0.7rem] font-medium"
                style={{ background: 'rgba(37, 211, 102, 0.15)', border: '1px solid rgba(37, 211, 102, 0.4)', color: '#86efac' }}
              >
          ...
          <div className="hidden min-[768px]:grid grid-cols-12" style={{ width: '100%', alignItems: 'stretch', maxWidth: '100%', gap: '0.75rem' }}>
            ...
            <div className="min-[900px]:col-span-5 max-[899px]:col-span-6 mb-3 min-[768px]:mb-0" style={{ width: '100%', paddingLeft: '0.5rem', paddingRight: '1rem', height: '100%' }}>
              <div className="grid grid-cols-4 gap-x-3 gap-y-0 md:gap-x-4 h-full">
                ...
                <nav className="flex flex-col gap-1.5 sm:gap-2 h-full col-span-2">
                  ...
                  {/* Botão CTA + Ícones Sociais - MESMO TAMANHO */}
                  <div className="pt-2 border-t border-white/10" style={{ marginTop: 'auto' }}>
                    {/* Botão - MESMA LARGURA DOS ÍCONES SOCIAIS (~175px) */}
                    <div className="flex justify-center mb-3">
                      <LangLink to="/contact" 
                        className="flex flex-col items-center justify-center rounded-xl border px-3 py-1.5 text-[0.62rem] sm:text-[0.64rem] font-medium transition-all"
                        style={{ 
                          color: '#ffffff',
                    ...
                    {/* Ícones Sociais - MESMA LARGURA (~175px = 5 ícones) */}
            ...
            <div className="min-[900px]:col-span-4 max-[899px]:col-span-12 mb-3 min-[768px]:mb-0" style={{ width: '100%', display: 'flex', flexDirection: 'column', gap: '1rem', paddingLeft: '1rem', paddingRight: '0.5rem' }}>
              ...
              {/* CONNECT - Contato: EMAIL + WHATSAPP EM UMA LINHA */}
              <div style={{ flexGrow: '0' }}>
                ...
                {/* Email + WhatsApp NA MESMA LINHA */}
                <div className="flex items-center gap-3 flex-wrap">
                  {/* Email */}
                  <a 
                    href="mailto:contact@azimutimmersive.com" 
                    className="flex items-center gap-2 text-[0.7rem] sm:text-[0.72rem] hover:text-[#8B2332] transition-colors"
                    style={{ color: '#cbd5e1' }}
                  >
                  ...
                  <a 
                    ...
                    target="_blank" 
                    rel="noopener noreferrer"
                    className="flex items-center gap-2 px-2.5 py-1.5 rounded-lg transition-all duration-300 hover:scale-105"
                    style={{ 
                    ...
                    onMouseEnter={(e) => {
                      ...
                      e.currentTarget.style.boxShadow = '0 0 15px rgba(37, 211, 102, 0.35)'
                    }}
                    onMouseLeave={(e) => {
          ...
          {/* Linha divisória - Legal (APENAS DESKTOP) */}
          <div className="hidden min-[768px]:block mt-6 sm:mt-8 md:mt-10 pt-4 sm:pt-5 md:pt-6 border-t border-white/10">
