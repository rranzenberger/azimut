...
import IntelligentNavigationSuggestions from './IntelligentNavigationSuggestions'
...
const Layout: React.FC<LayoutProps> = ({ children, lang, setLang, theme, toggleTheme }) => {
  ...
  return (
    <div className="min-h-screen w-full overflow-x-hidden" style={{ color: 'var(--theme-text)' }}>
          ...
          <nav role="navigation" aria-label="Menu principal" className="border-t backdrop-blur-md" style={{ borderColor: 'var(--theme-border)', backgroundColor: 'var(--theme-overlay)' }}>
            <div className="mx-auto max-w-7xl px-3 py-4 sm:px-4 sm:py-6 space-y-1">
              ...
              <div className="pt-3 mt-3 sm:pt-4 sm:mt-4 border-t space-y-2 sm:space-y-3" style={{ borderColor: 'var(--theme-border)' }}>
                <div className="flex items-center justify-center font-sora text-[0.7rem] sm:text-[0.8rem] font-medium uppercase tracking-[0.14em]" style={{ color: 'var(--theme-text-secondary)' }}>
                  {/* Grupo Canadá - EN e FR muito juntos */}
                  <span className="inline-flex items-center gap-0" style={{ alignItems: 'center' }}>
                    <img src="/flag-ca.svg" alt="Canada" width={32} height={16} className="w-auto rounded-[2px] opacity-95 mr-0.5" style={{ display: 'block', height: '17px', width: 'auto', maxHeight: '17px', maxWidth: '24px' }} />
                    <button
                  ...
                  {/* PT - Brasil */}
                  <span className="inline-flex items-center gap-0" style={{ alignItems: 'center' }}>
                    <img src="/flag-br.svg" alt="Brasil" width={32} height={16} className="w-auto rounded-[2px] opacity-95 mr-1" style={{ display: 'block', height: '17px', width: 'auto', maxHeight: '17px', maxWidth: '24px' }} />
                    <button
      ...
      {/* Navegação inteligente - "Você pode gostar" / Próximos passos (useIntelligentNavigation na UI) */}
      <IntelligentNavigationSuggestions lang={lang} theme={theme} maxItems={3} delayShowSeconds={4} />
        ...
        <div className="py-4 sm:py-5 min-[768px]:py-6" style={{ width: '100%', boxSizing: 'border-box', overflowX: 'visible' }}>
          ...
          <div className="min-[768px]:hidden">
            ...
            <div className="grid grid-cols-3 gap-2 mb-5 text-center">
              ...
              <nav className="flex flex-col gap-1" aria-label={t(lang, 'navFooterEdu')}>
                ...
                <div className="flex flex-col gap-0.5">
                  <LangLink to="/academy/courses" className="text-[0.55rem] text-slate-500 hover:text-azimut-red ml-2 inline-flex items-center min-h-[44px] py-1.5 -ml-2 pl-2 pr-2 rounded">└ {t(lang, 'navFooterCourses')}</LangLink>
                  <LangLink to="/academy/workshops" className="text-[0.55rem] text-slate-500 hover:text-azimut-red ml-2 inline-flex items-center min-h-[44px] py-1.5 -ml-2 pl-2 pr-2 rounded">└ Workshops</LangLink>
                  <LangLink to="/academy/corporate" className="text-[0.55rem] text-slate-500 hover:text-azimut-red ml-2 inline-flex items-center min-h-[44px] py-1.5 -ml-2 pl-2 pr-2 rounded">└ Corporate</LangLink>
                  <LangLink to="/academy/vancouver" className="text-[0.55rem] text-slate-500 hover:text-azimut-red ml-2 inline-flex items-center min-h-[44px] py-1.5 -ml-2 pl-2 pr-2 rounded">└ Vancouver</LangLink>
                </div>
              </nav>
            ...
            <div className="flex items-center justify-center gap-4 mb-6">
              <a href={footerSettings.youtubeUrl} target="_blank" rel="noopener noreferrer" className={theme === 'dark' ? 'text-white/60 hover:text-red-500 transition-colors' : 'text-slate-600 hover:text-red-500 transition-colors'} aria-label="YouTube">
              ...
              <a href={footerSettings.instagramUrl} target="_blank" rel="noopener noreferrer" className={theme === 'dark' ? 'text-white/60 hover:text-pink-500 transition-colors' : 'text-slate-600 hover:text-pink-500 transition-colors'} aria-label="Instagram">
              ...
              <a href={footerSettings.linkedinUrl} target="_blank" rel="noopener noreferrer" className={theme === 'dark' ? 'text-white/60 hover:text-blue-500 transition-colors' : 'text-slate-600 hover:text-blue-500 transition-colors'} aria-label="LinkedIn">
              ...
              <a href={footerSettings.vimeoUrl} target="_blank" rel="noopener noreferrer" className={theme === 'dark' ? 'text-white/60 hover:text-cyan-500 transition-colors' : 'text-slate-600 hover:text-cyan-500 transition-colors'} aria-label="Vimeo">
              ...
              <a href={footerSettings.behanceUrl} target="_blank" rel="noopener noreferrer" className={theme === 'dark' ? 'text-white/60 hover:text-blue-400 transition-colors' : 'text-slate-600 hover:text-blue-400 transition-colors'} aria-label="Behance">
            ...
            <div className="text-center mb-5 max-w-xs mx-auto">
              <h4 className={`font-sora text-[0.6rem] font-semibold uppercase tracking-wider mb-2 ${theme === 'dark' ? 'text-white' : 'text-slate-800'}`}>
              ...
              <div className="flex flex-col gap-2 w-full">
                ...
                >
                  ...
                  <span className="text-[0.65rem] min-[350px]:text-[0.75rem]">{footerSettings.contactEmail}</span>
                </a>
                <a 
                  href={`https://wa.me/${footerSettings.whatsappNumber}?text=Olá!%20Vim%20pelo%20site.`} 
                  target="_blank" 
          ...
          <div className="hidden min-[768px]:grid grid-cols-12" style={{ width: '100%', alignItems: 'stretch', maxWidth: '100%', gap: '0.75rem' }}>
            ...
            <div className="min-[900px]:col-span-5 max-[899px]:col-span-6 mb-3 min-[768px]:mb-0" style={{ width: '100%', paddingLeft: '0.5rem', paddingRight: '1rem', height: '100%', display: 'flex', flexDirection: 'column' }}>
              ...
              <div className="grid grid-cols-3 gap-x-4 md:gap-x-5" style={{ flex: '1' }}>
                ...
                <nav className="flex flex-col gap-1 sm:gap-1.5" style={{ justifyContent: 'flex-start' }}>
                  ...
                  <div className="mt-0.5 flex flex-col gap-0.5" style={{ flexGrow: '1' }}>
                    <LangLink to="/academy/courses" className="text-[0.6rem] sm:text-[0.65rem] transition-colors hover:text-[#8B2332] ml-2 inline-flex items-center min-h-[44px] py-1.5 pr-2 -ml-2 pl-2 rounded" style={{ color: '#94a3b8' }}>└ {t(lang, 'navFooterCourses')}</LangLink>
                    <LangLink to="/academy/workshops" className="text-[0.6rem] sm:text-[0.65rem] transition-colors hover:text-[#8B2332] ml-2 inline-flex items-center min-h-[44px] py-1.5 pr-2 -ml-2 pl-2 rounded" style={{ color: '#94a3b8' }}>└ Workshops</LangLink>
                    <LangLink to="/academy/corporate" className="text-[0.6rem] sm:text-[0.65rem] transition-colors hover:text-[#8B2332] ml-2 inline-flex items-center min-h-[44px] py-1.5 pr-2 -ml-2 pl-2 rounded" style={{ color: '#94a3b8' }}>└ Corporate</LangLink>
                    <LangLink to="/academy/vancouver" className="text-[0.6rem] sm:text-[0.65rem] transition-colors hover:text-[#8B2332] ml-2 inline-flex items-center min-h-[44px] py-1.5 pr-2 -ml-2 pl-2 rounded" style={{ color: '#94a3b8' }}>
              ...
              <div className="flex items-center justify-between pt-3 mt-3 relative" style={{ width: '100%' }}>
                ...
                {/* WhatsApp */}
                <a 
                  href={`https://wa.me/${footerSettings.whatsappNumber}?text=Olá!%20Gostaria%20de%20saber%20mais%20sobre%20os%20projetos%20da%20Azimut.`} 
                  target="_blank" 
                  rel="noopener noreferrer"
                ...
                <div className="flex items-center" style={{ gap: '0.4rem' }}>
                  ...
                  <a href={footerSettings.instagramUrl} target="_blank" rel="noopener noreferrer" className="social-icon-footer transition-all duration-300 hover:scale-110" aria-label="Instagram" style={{ opacity: 0.7 }} onMouseEnter={(e) => { e.currentTarget.style.opacity = '1'; const svg = e.currentTarget.querySelector('svg'); if (svg) (svg as SVGElement).style.color = '#E4405F' }} onMouseLeave={(e) => { e.currentTarget.style.opacity = '0.7'; const svg = e.currentTarget.querySelector('svg'); if (svg) (svg as SVGElement).style.color = '#ffffff' }}>
            ...
            <div className="min-[900px]:col-span-4 max-[899px]:col-span-12 mb-3 min-[768px]:mb-0" style={{ width: '100%', display: 'flex', flexDirection: 'column', gap: '0.75rem', paddingLeft: '1rem', paddingRight: '0.5rem' }}>
              ...
              <div style={{ marginTop: 'auto', paddingTop: '0.75rem' }}>
                ...
                >
                  ...
                  <span className="text-[0.65rem] min-[400px]:text-[0.75rem]">{footerSettings.contactEmail}</span>
                </a>
              </div>
              </div>
            </div>
