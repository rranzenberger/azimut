...
const LoadingSkeleton: React.FC = () => {
  return (
    <div className="min-h-screen w-full flex items-center justify-center bg-gradient-to-b from-black via-[#0a0e18] to-black" role="status" aria-live="polite" aria-label="Loading page content">
      <div className="flex flex-col items-center gap-6">
        ...
        <div className="flex flex-col items-center gap-2">
          <p className="text-sm font-sora uppercase tracking-wider text-azimut-red animate-pulse">
            Loading...
          </p>
          <div className="h-1 w-24 bg-azimut-red/20 rounded-full overflow-hidden">
