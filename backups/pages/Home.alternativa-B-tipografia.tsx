...
// AnimatedLogo removido - usando tipografia monumental 2026
  ...
  return (
    <>
      ...
      <main className="relative">
        ...
        {/* ════════════════════════════════════════════════════════════════ */}
        {/* HERO PREMIUM 2026 - TIPOGRAFIA MONUMENTAL */}
        {/* Trend #1: Tipografia gigante como visual principal */}
        {/* Padrão: Stripe, Linear, Vercel, Resend */}
        {/* ════════════════════════════════════════════════════════════════ */}
        <section className="relative h-screen min-h-[700px] overflow-hidden">
          ...
          <div className="relative z-10 h-full flex flex-col items-center justify-center px-4 sm:px-6 lg:px-8">
            ...
            <h1 className="font-handel uppercase text-center leading-none mb-8 animate-fade-in-up opacity-0" style={{ 
              fontSize: 'clamp(3.5rem, 12vw, 10rem)',
              letterSpacing: '0.08em',
              animationDelay: '0.2s'
            }}>
              <span className="block text-white">{heroSlogan.split(' ').slice(0, 2).join(' ')}</span>
              <span className="block text-white opacity-90">{heroSlogan.split(' ').slice(2, 4).join(' ')}</span>
              <span className="block text-azimut-red mt-2">{heroSlogan.split(' ').slice(-1)}</span>
            </h1>
            
            {/* Pills inline (não cards) - Ultra compacto */}
            <div className="flex flex-wrap justify-center gap-3 text-[0.7rem] uppercase tracking-wider mb-6 animate-fade-in-up opacity-0" style={{ animationDelay: '0.4s' }}>
            ...
            <p className="text-white/50 text-xs uppercase tracking-widest mb-10 animate-fade-in-up opacity-0" style={{ animationDelay: '0.5s' }}>
            ...
            <button 
              ...
              className="px-6 py-2 border border-white/20 rounded-full text-white text-xs uppercase tracking-wider hover:border-azimut-red/50 hover:text-azimut-red transition-all duration-300 animate-fade-in-up opacity-0"
