/**
 * Copia o build do Empathy Engine (azimut-empathy-engine/dist) para public/game
 * para ser servido em /game/ no site principal.
...
const publicGameDir = path.join(__dirname, '..', 'public', 'game')
...
console.log('Build do jogo copiado para public/game')
