# 🎯 SCRIPTS SQL - COPIAR E COLAR NO NEON

**Execute um por vez no SQL Editor do Neon: https://console.neon.tech**

---

## 📝 **PASSO 1: Verificar se a tabela existe**

Copie e execute este SQL primeiro:

```sql
SELECT COUNT(*) FROM "CompanyHistory";
```

**Se der erro "tabela não existe", pule para o PASSO 2.**  
**Se retornar um número, a tabela já existe! Vá para o PASSO 3.**

---

## 🗑️ **PASSO 2: Limpar dados existentes (OPCIONAL)**

⚠️ **CUIDADO: Isso apaga TODOS os dados da tabela!**

Só execute se quiser limpar e começar do zero:
...
## 📊 **PASSO 3: Inserir eventos - 1980s (Formação)**
...
## 📊 **PASSO 4: Inserir eventos - 1996 (Fundação)**
...
## 📊 **PASSO 5: Inserir eventos - 1997-1999**
...
'🌍', true, 55,
ARRAY['Cursos em Recife, Fortaleza, Maranhão, Belém', 'Serviços para redes de TV e produtoras', 'Instituto de Arte Contemporânea (Recife)'],
ARRAY['Courses in Recife, Fortaleza, Maranhão, Belém', 'Services for TV networks and producers', 'Contemporary Art Institute (Recife)']
);
```

---

## 📊 **PASSO 6: Inserir eventos - 2000-2005 (PARTE 1)**

```sql
-- 2000: Circuito Universitário
INSERT INTO "CompanyHistory" ("year", "type", "titlePt", "titleEn", "icon", "displayOrder")
VALUES 
(2000, 'milestone', 'Circuito Universitário de CG 3D', 'University Circuit of 3D CG', '🎓', 60);

-- 2001: TechnoIMAGE
INSERT INTO "CompanyHistory" ("year", "type", "titlePt", "titleEn", "icon", "isFeatured", "displayOrder")
VALUES 
(2001, 'partnership', 'Discreet - TechnoIMAGE 2001 (SP)', 'Discreet - TechnoIMAGE 2001 (SP)', '🎤', true, 70);
...
## 📊 **PASSO 7: Inserir eventos - 2003-2005 (PARTE 2)**
...
VALUES 
(2003, 'partnership', 'Discreet - Contrato Expandido NAB', 'Discreet - Expanded NAB Contract',
...
'🌟', true, 80,
ARRAY['Maior evento broadcast: NAB', 'Único contato Brasil animação Discreet', 'Designer gráfico website Discreet Brasil'],
ARRAY['Largest broadcast event: NAB', 'Only Brazil contact Discreet animation', 'Graphic designer Discreet Brasil website']
);
...
## 📊 **PASSO 8: Inserir eventos - 2007-2012**

```sql
-- 2007-2012: Brasília Tropicalis
INSERT INTO "CompanyHistory" ("year", "yearEnd", "type", "titlePt", "titleEn", "descriptionPt", "descriptionEn", "icon", "displayOrder")
VALUES 
(2007, 2012, 'project', 'Brasília Tropicalis - Olympya', 'Brasília Tropicalis - Olympya',
'Designer gráfico para game de fotografia da natureza. Fundos SEBRAE.',
'Graphic designer for nature photography game. SEBRAE funds.',
'🌿', 120);

-- 2007-2009: UERJ MBA
INSERT INTO "CompanyHistory" ("year", "yearEnd", "type", "titlePt", "titleEn", "icon", "displayOrder")
VALUES 
(2007, 2009, 'partnership', 'UERJ - MBA Animação & Multimídia', 'UERJ - MBA Animation & Multimedia', '🎓', 125);

-- 2008-2010: SENAC
INSERT INTO "CompanyHistory" ("year", "yearEnd", "type", "titlePt", "titleEn", "icon", "displayOrder")
VALUES 
(2008, 2010, 'partnership', 'SENAC - Contrato de Cursos', 'SENAC - Course Contract', '🎓', 130);
...
## 📊 **PASSO 9: Inserir eventos - 2010+ (Era Moderna)**
...
**Deve retornar aproximadamente 30 eventos.**

Para ver todos:

```sql
SELECT "year", "titlePt", "type" FROM "CompanyHistory" ORDER BY "year", "displayOrder";
```
...
Agora teste:
- **API:** https://cms.azimut.com.br/api/public/history?lang=pt
- **Frontend:** http://localhost:5173/pt/studio/credibilidade

---

**✨ Execute os passos na ordem e pronto! ✨**
