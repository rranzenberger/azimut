...
import { GameFooter } from './components/ui'
import './index.css'
...
function App() {
  ...
  return (
    <div className="game-bg relative h-screen min-h-screen overflow-hidden flex flex-col">
      {/* Partículas animadas de fundo */}
      <ParticlesBackground />
      
      {/* Conteúdo principal - ocupa todo o espaço menos o rodapé */}
