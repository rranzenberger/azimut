...
export async function PUT(
  ...
  try {
    ...
    const {
      ...
      // Hero Media (home): imagem + demoreel
    ...
    const page = await prisma.page.update({
      ...
      data: {
        ...
        ...(pillar1Es !== undefined && { pillar1Es }),
        ...(pillar1Fr !== undefined && { pillar1Fr }),
        ...(pillar2Pt !== undefined && { pillar2Pt }),
        ...(pillar2En !== undefined && { pillar2En }),
        ...(pillar2Es !== undefined && { pillar2Es }),
        ...(pillar2Fr !== undefined && { pillar2Fr }),
        ...(pillar3Pt !== undefined && { pillar3Pt }),
        ...(pillar3En !== undefined && { pillar3En }),
        ...
        // Hero Media (home): aceita limpar com string vazia => null
        ...(heroBackgroundImageId !== undefined && { heroBackgroundImageId: heroBackgroundImageId || null }),
