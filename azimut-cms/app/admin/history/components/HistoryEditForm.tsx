...
export function HistoryEditForm({ history }: { history?: any }) {
  ...
  const [formData, setFormData] = useState({
    ...
    bulletsPt: (Array.isArray(history?.bulletsPt) ? history.bulletsPt : []).join('\n'),
    bulletsEn: (Array.isArray(history?.bulletsEn) ? history.bulletsEn : []).join('\n'),
    bulletsEs: (Array.isArray(history?.bulletsEs) ? history.bulletsEs : []).join('\n'),
    bulletsFr: (Array.isArray(history?.bulletsFr) ? history.bulletsFr : []).join('\n'),
    icon: history?.icon || '',
