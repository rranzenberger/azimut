-- ═══════════════════════════════════════════════════════════════
-- POPULAR BLOG AZIMUT - VERSÃO FINAL CORRIGIDA
-- ═══════════════════════════════════════════════════════════════
-- Campo correto: readingTimeMin (NÃO readTimeMinutes)
-- ═══════════════════════════════════════════════════════════════
...
SELECT uuid_generate_v4(), 'projetos', 'Projetos', 'Projects', 'Proyectos', 'Projets', '#c92337', '🎬', 10, NOW(), NOW()
WHERE NOT EXISTS (SELECT 1 FROM "BlogCategory" WHERE slug = 'projetos');

INSERT INTO "BlogCategory" (id, slug, "namePt", "nameEn", "nameEs", "nameFr", "color", icon, priority, "createdAt", "updatedAt")
SELECT uuid_generate_v4(), 'tecnologia', 'Tecnologia', 'Technology', 'Tecnología', 'Technologie', '#3b82f6', '💻', 9, NOW(), NOW()
WHERE NOT EXISTS (SELECT 1 FROM "BlogCategory" WHERE slug = 'tecnologia');

INSERT INTO "BlogCategory" (id, slug, "namePt", "nameEn", "nameEs", "nameFr", "color", icon, priority, "createdAt", "updatedAt")
SELECT uuid_generate_v4(), 'cultura', 'Cultura', 'Culture', 'Cultura', 'Culture', '#10b981', '🏛️', 8, NOW(), NOW()
WHERE NOT EXISTS (SELECT 1 FROM "BlogCategory" WHERE slug = 'cultura');

INSERT INTO "BlogCategory" (id, slug, "namePt", "nameEn", "nameEs", "nameFr", "color", icon, priority, "createdAt", "updatedAt")
SELECT uuid_generate_v4(), 'por-tras-das-cenas', 'Por Trás das Cenas', 'Behind the Scenes', 'Detrás de Escena', 'Dans les Coulisses', '#f59e0b', '🎭', 7, NOW(), NOW()
