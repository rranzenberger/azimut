// ════════════════════════════════════════════════════════════
// SCRIPT: ADICIONAR VÍDEOS AOS PROJETOS
// ════════════════════════════════════════════════════════════
// Objetivo: Adicionar vídeos do YouTube/Vimeo aos projetos
// Como usar: Cole URLs dos vídeos abaixo e execute o script
// ════════════════════════════════════════════════════════════
...
// 1. URL do vídeo (YouTube ou Vimeo)
// 2. Se for YouTube: https://www.youtube.com/watch?v=VIDEO_ID
// 3. Se for Vimeo: https://vimeo.com/VIDEO_ID
//
// O script vai:
// - Extrair ID do vídeo automaticamente
// - Criar thumbnail do YouTube/Vimeo
// - Criar registro Media tipo VIDEO
// - Associar ao projeto
//
// ═══════════════════════════════════════════════════════════════════

const videosPorProjeto = {
  ...
  'instalacao-imersiva': {
    ...
    // OU Vimeo: 'https://vimeo.com/123456789'
  ...
  // ───────────────────────────────────────────────────────────
  // PROJETO: Natal Cultural
  // ───────────────────────────────────────────────────────────
  'natal-cultural': {
    videoUrl: '',
    alt: 'Vídeo Natal Cultural'
  },
  ...
  'gramado-vr-ia': {
    videoUrl: '',
    alt: 'Vídeo Festival Gramado VR/IA'
  },
...
async function main() {
  console.log('🎬 Adicionando vídeos aos projetos...\n')

  let adicionados = 0
  let ignorados = 0
  let erros = 0

  for (const [slug, dados] of Object.entries(videosPorProjeto)) {
    try {
...
// COMO EXECUTAR:
// ════════════════════════════════════════════════════════════
// 1. Edite este arquivo e cole as URLs dos vídeos
// 2. Execute:
//    cd azimut-cms
